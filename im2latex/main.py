...
def parse_args():
    ...
    ap.add_argument("--decoder_ckpt",                type=str,   default=None)
    ...
    ap.add_argument("--projector_intermediate_size", type=int,   default=2048)
    ...
    ap.add_argument("--trainer",                     type=str,   default="ddp")
